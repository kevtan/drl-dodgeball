...
#def create_manual_arrow(body,shape,space,flying_arrows,power):
...
def runManualGame():
    screen,clock,running,space,static,b2,cannon_body,cannon_shape,draw_options,font = initialize_game()
    ...
    while running:
        #Handle manual player interactions with the board and arrow
